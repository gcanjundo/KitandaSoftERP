...
{
    public class QualificationsConfiguration : IEntityTypeConfiguration<Qualifications>
    {
        public void Configure(EntityTypeBuilder<Qualifications> builder)
        {
            ...
            builder.ToTable("ger_qualification");

            builder.Property(e => e.ID)
                .HasColumnName("QUAL_CODIGO")
                .HasColumnType("int(11)");

            builder.Property(e => e.Designation)
                .HasColumnName("QUAL_DESCRICAO")
                .HasColumnType("varchar(120)").IsRequired(true);

            builder.Property(e => e.DesignationOtherLanguage)
                .HasColumnName("QUAL_DESIGNATION_OTHER_LANGUAGE")
                .HasColumnType("varchar(120)").IsRequired(false);

            builder.Property(e => e.Status)
                .HasColumnName("QUAL_ESTADO")
                .HasColumnType("bit(1)");

            builder.Property(e => e.ShortName)
                .HasColumnName("QUAL_SIGLA")
